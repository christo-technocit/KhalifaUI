...
@Component({
  ...
  templateUrl: './sb-clinical-details.component.html',
})
export class SbClinicalDetailsComponent implements OnInit {
  form:FormGroup;
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(2,2).subscribe((res)=> {
