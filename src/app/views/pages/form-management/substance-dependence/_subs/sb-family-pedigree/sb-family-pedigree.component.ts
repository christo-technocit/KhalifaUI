...
@Component({
  ...
  templateUrl: './sb-family-pedigree.component.html',
})
export class SbFamilyPedigreeComponent implements OnInit {
  form: FormGroup;
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(2, 14).subscribe((res) => {
